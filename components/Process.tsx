      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-fade-in" onClick={onClose}>
         ...
         >
            ...
            <div className="w-full md:w-1/3 bg-neutral-800 p-10 flex flex-col justify-between">
               <div>
                  <h2 className="text-gold-400 text-xs tracking-[0.3em] uppercase mb-6">{t('process.title')}</h2>
                  <h3 className="text-3xl font-serif text-white leading-tight word-keep-all whitespace-pre-line">
                     <Trans i18nKey="process.subtitle" />
                  </h3>
               </div>
            ...
            <div className="w-full md:w-2/3 p-10 md:p-14 space-y-12 bg-neutral-900">
               ...
               <div className="flex gap-6 group">
                  ...
                  <div>
                     <h4 className="text-lg text-white font-serif mb-3">{t('process.step1_title')}</h4>
               ...
               <div className="flex gap-6 group">
                  ...
                  <div>
                     <h4 className="text-lg text-white font-serif mb-3">{t('process.step2_title')}</h4>
                     <p className="text-neutral-400 text-sm leading-loose word-keep-all">
               ...
               <div className="flex gap-6 group">
                  ...
                  <div>
                     <h4 className="text-lg text-white font-serif mb-3">{t('process.step3_title')}</h4>
                     <p className="text-neutral-400 text-sm leading-loose word-keep-all">
